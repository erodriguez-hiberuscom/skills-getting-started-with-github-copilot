      ...
      Object.entries(activities).forEach(([name, details]) => {
          ...
          participantCount > 0
            ? details.participants.map((email) => `
              <li class="participant-item">
                ...
                <button class="remove-participant-btn" data-activity="${name}" data-email="${email}" title="Remove participant" aria-label="Remove ${email} from ${name}">
                  ✕
                </button>
              </li>
            `).join("")
        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-section">
            <p class="participants-title">Participants (${participantCount})</p>
